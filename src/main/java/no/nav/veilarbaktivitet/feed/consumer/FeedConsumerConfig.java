...
public class FeedConsumerConfig<DOMAINOBJECT> {
	...
	public FeedConsumerConfig(
		BaseConfig<DOMAINOBJECT> baseConfig,
		ScheduleCreator pollingConfig,
	...
	public FeedConsumerConfig(
		BaseConfig<DOMAINOBJECT> baseConfig,
		ScheduleCreator pollingConfig,
		WebhookScheduleCreator webhookPollingConfig,
		LeaderElectionClient leaderElectionClient
	) {
	...
	public FeedConsumerConfig<DOMAINOBJECT> authorizatioModule(
	...
	public FeedConsumerConfig<DOMAINOBJECT> interceptors(
	...
	public FeedConsumerConfig<DOMAINOBJECT> callback(
		FeedCallback<DOMAINOBJECT> callback
	) {
	...
	public static class CronWebhookPollingConfig extends WebhookScheduleCreator {
		...
		public CronWebhookPollingConfig(
	...
	public static class SimpleWebhookPollingConfig
		...
		public SimpleWebhookPollingConfig(
			int webhookPollingIntervalInSeconds,
			String apiRootPath
		) {
			super(
				simpleSchedule()
					.withIntervalInSeconds(webhookPollingIntervalInSeconds)
					.repeatForever(),
				apiRootPath
			);
		}
