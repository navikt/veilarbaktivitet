...
public class ApplicationContext {
	...
	public static final String ARENA_AKTIVITET_DATOFILTER_PROPERTY =
		"ARENA_AKTIVITET_DATOFILTER";
	public static final String VEILARBOPPFOLGINGAPI_URL_PROPERTY =
		"VEILARBOPPFOLGINGAPI_URL";
	public static final String VIRKSOMHET_TILTAKOGAKTIVITET_V1_ENDPOINTURL_PROPERTY =
		"VIRKSOMHET_TILTAKOGAKTIVITET_V1_ENDPOINTURL";
	public static final String VEILARB_KASSERING_IDENTER_PROPERTY =
		"VEILARB_KASSERING_IDENTER";
	...
	public SystemUserTokenProvider systemUserTokenProvider(
		...
		return new NaisSystemUserTokenProvider(
			properties.getNaisStsDiscoveryUrl(),
	...
	public AktorOppslagClient aktorOppslagClient(
		...
		AktorregisterClient aktorregisterClient = new AktorregisterHttpClient(
			properties.getAktorregisterUrl(),
			APPLICATION_NAME,
	...
	@Bean
	public static TiltakOgAktivitetV1 tiltakOgAktivitetV1Client(
		EnvironmentProperties properties,
