...
public class FeedConfig {
	...
	public FeedController feedController(
		...
		feedController.addFeed(
			...
			avsluttetOppfolgingFeedItemFeedConsumer
		);
	...
	public FeedConsumer<KvpDTO> kvpDTOFeedConsumer(
		KvpFeedConsumer kvpFeedConsumer,
		OkHttpClient client,
		...
		FeedConsumerConfig<KvpDTO> config = new FeedConsumerConfig<>(
			baseConfig,
			new FeedConsumerConfig.SimplePollingConfig(10),
	...
	@Bean
	public FeedConsumer<AvsluttetOppfolgingFeedDTO> avsluttetOppfolgingFeedItemFeedConsumer(
