...
public class Helpers {
	public static final BidiMap<AktivitetTypeData, AktivitetTypeDTO> typeMap = new DualHashBidiMap<AktivitetTypeData, AktivitetTypeDTO>() {
	...
	public static final BidiMap<StillingsoekEtikettData, EtikettTypeDTO> etikettMap = new DualHashBidiMap<StillingsoekEtikettData, EtikettTypeDTO>() {

		{
			put(StillingsoekEtikettData.AVSLAG, EtikettTypeDTO.AVSLAG);
			put(
				StillingsoekEtikettData.INNKALT_TIL_INTERVJU,
				EtikettTypeDTO.INNKALT_TIL_INTERVJU
			);
	...
	public static final BidiMap<JobbStatusTypeData, JobbStatusTypeDTO> jobbStatusMap = new DualHashBidiMap<JobbStatusTypeData, JobbStatusTypeDTO>() {
