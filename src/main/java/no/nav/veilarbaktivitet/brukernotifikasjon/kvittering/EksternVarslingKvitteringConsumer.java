...
public class EksternVarslingKvitteringConsumer {
    ...
    @Transactional
    @KafkaListener(topics = "${topic.inn.brukernotifikasjon.brukervarselHendelse}", containerFactory = "stringStringKafkaListenerContainerFactory", autoStartup = "${app.kafka.enabled:false}")
