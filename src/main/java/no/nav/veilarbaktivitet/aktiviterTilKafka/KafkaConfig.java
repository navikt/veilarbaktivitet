...
public class KafkaConfig {
	public static final String KAFKA_TOPIC_AKTIVITETER_V4 = getRequiredProperty(
		"KAFKA_TOPIC_AKTIVITETER_V4"
	);
	public static final String KAFKA_BROKERS = getRequiredProperty(
		"KAFKA_BROKERS_URL"
	);
