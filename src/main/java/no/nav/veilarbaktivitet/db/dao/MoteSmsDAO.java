...
public class MoteSmsDAO {
	...
	public List<SmsAktivitetData> hentIkkeAvbrutteMoterMellom(
		Date fra,
		Date til
	) {
	...
	public void insertSmsSendt(
		SmsAktivitetData smsAktivitetData,
		String varselId
	) {
	...
	public long antallAktivteterSendtSmsPaa() {
		...
		return database.queryForObject(
			"select count(*) from GJELDENDE_MOTE_SMS",
			Long.class
		);
	}
	...
	public long antallSmsSendt() {
		//language=sql
		return database.queryForObject(
			"select count(*) from MOTE_SMS_HISTORIKK",
			Long.class
		);
	}
}
