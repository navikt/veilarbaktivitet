...
public class AktivitetDataRowMapper {
    public static AktivitetData mapAktivitet(ResultSet rs) throws SQLException {
        ...
        val aktivitet = AktivitetData
                ...
                .aktivitetType(type)
                .fraDato(Database.hentDatoMedTidssone(rs, "fra_dato"))
                .tilDato(Database.hentDatoMedTidssone(rs, "til_dato"))
                ...
                .opprettetDato(Database.hentDatoMedTidssone(rs, "opprettet_dato"))
                .endretDato(Database.hentDatoMedTidssone(rs, "endret_dato"))
                ...
                .historiskDato(Database.hentDatoMedTidssone(rs, "historisk_dato"))
                .kontorsperreEnhetId(rs.getString("kontorsperre_enhet_id"))
                .lestAvBrukerForsteGang(Database.hentDatoMedTidssone(rs, "lest_av_bruker_forste_gang"))
