...
class HttpExceptionHandler: ResponseEntityExceptionHandler() {
    ...
    @ExceptionHandler(value = [EndringAvFerdigAktivitetException::class])
    fun handleConflict(ex: EndringAvFerdigAktivitetException, request: WebRequest): ResponseEntity<Response> {
        val statusKode = 400
