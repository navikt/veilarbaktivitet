...
internal class OppfolgingsperiodeConsumerTest : SpringBootTestBase() {
    ...
    fun skal_opprette_siste_oppfolgingsperiode() {
        ...
        assertThat(oppfolgingsperiode.oppfolgingsperiode).isEqualTo(mockBruker.getOppfolgingsperiodeId())
        ...
        assertThat(oppfolg.oppfolgingsperiode).isEqualTo(mockBruker.getOppfolgingsperiodeId())
