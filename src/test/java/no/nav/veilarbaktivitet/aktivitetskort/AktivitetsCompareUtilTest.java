...
class AktivitetsCompareUtilTest {

    @Test
    void deltakelsestatusendring_skal_være_faktisk_endring() {
    ...
    @Test
    void forhåndsorientering_er_ikke_faktisk_endring() {
        var gammelAktivitet = AktivitetDataTestBuilder.nyEksternAktivitet();
        var nyAktivitet = gammelAktivitet
    ...
    @Test
    void aktivitetsstatus_endring_er_ikke_faktisk_endring() {
        var gammelAktivitet = AktivitetDataTestBuilder.nyEksternAktivitet()
    ...
    @Test
    void tiltaksnavn_endring_er_faktisk_endring() {
        var gammelAktivitet = AktivitetDataTestBuilder.nyEksternAktivitet();
        var nyAktivitet = gammelAktivitet
