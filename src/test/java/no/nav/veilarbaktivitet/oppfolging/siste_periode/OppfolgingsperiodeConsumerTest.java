...
class OppfolgingsperiodeConsumerTest extends SpringBootTestBase {
    ...
    void skal_opprette_siste_oppfolgingsperiode() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        kafkaTestService.assertErKonsumertSpringKafka(oppfolgingSistePeriodeTopic, sendResult.getRecordMetadata().offset(), 10);
        ...
        kafkaTestService.assertErKonsumertSpringKafka(oppfolgingSistePeriodeTopic, avsluttetSendResult.getRecordMetadata().offset(), 5);
    ...
    void skal_avslutte_aktiviteter_for() throws ExecutionException, InterruptedException {
        ...
        kafkaTestService.assertErKonsumertSpringKafka(oppfolgingSistePeriodeTopic, sendResult.getRecordMetadata().offset(), 5);
